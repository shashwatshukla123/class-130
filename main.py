...
#It will give us the number of rows and the number of column in csv files.
# 4284 rows and 85 columns
...
del df["rowupdate"]
del df["pl_facility"]
print("After delating the column")
...
format(size, shape, shape[0]*shape[1]))
# 4284,19
# It's means 84 column are deleated
